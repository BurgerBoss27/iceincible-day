...
//that means that I steal it from shadertoy lol https://www.shadertoy.com/view/Ms23DR
...
void mainImage(void)
{
    ...
    vec2 uv = q;
    uv = curve( uv );
    vec4 oricol = texture( iChannel0, vec2(q.x,q.y) );
    vec3 col;
